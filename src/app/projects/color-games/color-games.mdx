...
<div className="not-prose grid gap-4 sm:grid-cols-2">
  <figure className="rounded-2xl overflow-hidden ring-1 ring-slate-200 bg-white shadow-sm">
    <div className="relative aspect-[4/3]">
      <Image
        src="/images/projects/color-math/resolution-before.png"
  ...
  <figure className="rounded-2xl overflow-hidden ring-1 ring-slate-200 bg-white shadow-sm">
    <div className="relative aspect-[4/3]">
      <Image
        src="/images/projects/color-math/resolution-after.png"
    ...
    <figcaption className="px-4 py-3 text-xs text-slate-600">
      <strong>After:</strong> Forced HDMI mode on the Pi → proper scaling and readability.
    </figcaption>
  </figure>
</div>
