...
<div className="not-prose grid gap-4 sm:grid-cols-2">
  {/* BEFORE */}
  <figure className="rounded-2xl overflow-hidden ring-1 ring-slate-200 bg-white shadow-sm">
    <div className="relative aspect-[4/3]">
      <Image
        src="/projects/color-math/resolution-before.png"
        alt="Before: wrong tablet resolution (UI overflow)"
        fill
        className="object-cover"        {/* ⬅ was object-contain; removes letterboxing */}
      />
    </div>
    <figcaption className="px-4 py-3 text-xs text-slate-600">
      <strong>Before:</strong> Wrong display mode → overflowed UI, unreadable text.
    </figcaption>
  </figure>
  ...
  <figure className="rounded-2xl overflow-hidden ring-1 ring-slate-200 bg-white shadow-sm">
    <div className="relative aspect-[4/3]">
      <Image
        src="/projects/color-math/resolution-after.png"
        alt="After: correct HDMI mode; proper scaling"
        fill
        className="object-cover"        {/* ⬅ same change here */}
      />
    </div>
    <figcaption className="px-4 py-3 text-xs text-slate-600">
      <strong>After:</strong> Forced HDMI mode → proper scaling and readability.
    </figcaption>
  </figure>
</div>
