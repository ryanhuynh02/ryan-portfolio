  ...
  <figure className="rounded-xl border bg-white p-2 shadow-sm">
    <div className="relative aspect-[4/3] rounded-lg overflow-hidden">
      <Image
        ...
        alt="Before: UI overflowed because the Pi detected the wrong tablet resolution"
        fill
  ...
  <figure className="rounded-xl border bg-white p-2 shadow-sm">
    <div className="relative aspect-[4/3] rounded-lg overflow-hidden">
      <Image
        ...
        alt="After: Correct HDMI mode set on Raspberry Pi; UI fits and text is readable"
        fill
        className="object-contain bg-white"
      />
    </div>
