...
<ul className="list-disc pl-6 space-y-2 marker:text-slate-600">
  ...
  <lil>My main responsibility was building the cognitive games, but I also assisted with the Raspberry Pi setup and installing the Dynamixel package when we encountered issues. Throughout the internship, we held weekly meetings to update each other on progress, solve technical and robot-related challenges, and stay aligned as a team. At the end of the internship, we created a full PowerPoint presentation and shared our project with different labs to showcase what we accomplished.
    <div className="grid sm:grid-cols-2 gap-4 not-prose">
      <div className="relative aspect-[4/3] rounded-xl overflow-hidden border">
        <Image src="/projects/color-math/color-game.jpg" alt="Robot Base" fill className="object-cover" />
      </div>
      <div className="relative aspect-[4/3] rounded-xl overflow-hidden border">
        <Image src="/projects/color-math/math-game.jpg" alt="Robot Body" fill className="object-cover" />
      </div>
    </div>
  </li>
</ul>
