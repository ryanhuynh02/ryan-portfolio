...
export default function DoorSensorProjectPage() {
  ...
  return (
    <main className="max-w-4xl mx-auto px-4 py-10 text-slate-900 dark:text-slate-100">
      <div className="flex items-center justify-between gap-4">
        ...
        <Link
          href="/projects"
          className="text-sm underline text-slate-600 hover:text-slate-900 dark:text-slate-300 dark:hover:text-white"
        >
          ← Back to Projects
        </Link>
      </div>

      <div className="mt-6 prose prose-slate dark:prose-invert max-w-none prose-img:rounded-xl">
        <MDXRemote
          source={mdx}
      ...
      <div className="mt-8">
        <a
          ...
          className="inline-flex items-center gap-2 rounded-xl bg-slate-900 text-white px-4 py-2 text-sm dark:bg-slate-100 dark:text-slate-900"
        >
          Download PDF
        </a>
      </div>
