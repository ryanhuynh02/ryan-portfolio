...
type Props = {
  ...
  aspect?: string;
  /** Start position in percent (0–100). Default 50. */
  initial?: number;
  /** Optional labels shown on the images. */
  labelBefore?: string;
  labelAfter?: string;
  className?: string;
  /** Show the range input under the slider. Default true. */
    ...
    >
      ...
      >
        ...
        <div
            ...
            aria-hidden
        >
            <Image src={after} alt="" fill className="object-cover" />
        </div>
        ...
        {/* Handle */}
        <div
          className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 h-6 w-6 rounded-full
